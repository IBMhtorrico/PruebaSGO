...
//-------------------------------------------------------------------------------------------------
	...
	public RespuestaCompuesta guardarRegistro(DetalleProgramacion eDetalleProgramacion){
		...
		try {
			...
			consultaSQL.append(" (id_programacion, id_cisterna, id_producto, id_conductor, id_planta, orden_compra, codigo_scop, codigo_sap_pedido, numero_compartimento, capacidad_volumetrica) ");
			consultaSQL.append(" VALUES (:IdProgramacion, :IdCisterna, :IdProducto, :IdConductor, :IdPlanta, :OrdenCompra,  :CodigoScop, :CodigoSapPedido, :NumeroCompartimento, :CapacidadVolumetrica) ");// Inicio Atención Ticket 9000002608
