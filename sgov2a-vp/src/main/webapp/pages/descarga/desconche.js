$(document).ready(function(){
  ...
  moduloActual.llenarFormulario = function(registro){
    ...
    var opcionElemento = "<option value='"+registro.idDescargaCisterna+"'>"+"F. Planificada:"+utilitario.formatearFecha(registro.fechaPlanificada)+" Tracto / Cisterna: "+registro.placaTracto+" / " + registro.placaCisterna+" Estación: "+registro.estacion+" Tanque: "+registro.tanque+"</option>";
