function moduloProgramacion (){
  ...
  console.log('Iniciando Modulo Programación');
};
	  ...
	  $.ajax({
	    ...
	    success: function(respuesta) {
	      if (!respuesta.estado) {
	    	  ...
	    	  //ref.listarRegistros();
	    	  ref.actualizarBandaInformacion(constantes.TIPO_MENSAJE_EXITO,respuesta.mensaje);  
	    	  //se tiene que programar sólo cuando la notificación es correcta
...
//sólo cuando el día operativo se encuentre en estqado planificado habilitamos los botones  
